...
// Setup ajax connections safetly
 ...
 function expand(el) {
  ...
  function fun_moin_bathint() {

document.getElementById("id_bathint").childNodes[0].childNodes[0].lastChild.remove()
document.getElementById("id_bathint").childNodes[0].childNodes[1].lastChild.remove()

  }

    function fun_plus_bathint() {
document.getElementById("id_bathint").childNodes[0].childNodes[0].insertAdjacentHTML('beforeend', '<td><input value="0" style="width:85%;height:85%"></td>');
document.getElementById("id_bathint").childNodes[0].childNodes[1].insertAdjacentHTML('beforeend', '<td><input value="0" style="width:85%;height:85%"></td>');
